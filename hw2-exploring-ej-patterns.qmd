...
---
# Introduction
As a racially diverse area of the United States, Los Angeles acts as a case study for the far reaching environmental injustices that occur nationwide. In the 1930's the Home Owner's Loan Corporation (HOLC) gave neighborhoods grades from A to D defining what portions of the city they perceived as worthy of real estate investments. The consequence is that even today effects from this racially motivated grading system manifest in the form of unequal risk to being exposed to environmental hazards. This project explores contemporary 
symptoms of what has come to be known as redlining. 
...
When considering how to construct a map of Los Angeles' redlined neighborhoods, the growth of Los Angeles in the last century indicates that not all of present day Los Angeles would have a HOLC grade. Therefore, a baselayer is added to make the map complete. 
```{r}
