...
ej_redlining <- st_join(la_ejscreen, redlining, by = st_within)
...
CHANGE TO GROUP_BY() PIPE SUMMARIZE()
```{r}
...
bio_redlining <- st_join(bio_div, redlining, by = st_within())
